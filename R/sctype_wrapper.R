...
#'
#' @details This function is compatible with seurat versions 4 and 5 --
#' different methods(@,$) to retrieve counts,data,scale.data
#'
#' @name run_scType
#'
...
#' @param name The name of the metadata column to store the scType results
#' (default is "sctype_classification")
#'
...
run_sctype <- function(seurat_object, known_tissue_type = NULL, assay = "RNA",
                       scaled = TRUE, custom_marker_file = NULL, plot = FALSE,
