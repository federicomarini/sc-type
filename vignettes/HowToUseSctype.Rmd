...
gs_list <- gene_sets_prepare(system.file("extdata", "ScTypeDB_short.xlsx", package = "sctype"), 
                             "Immune system") # e.g. Immune system, Liver, Pancreas, Kidney, Eye, Brain

# load example (scaled/normalized) scRNA-seq matrix
scRNAseqData <- readRDS(system.file("extdata", "exampleData.RDS", package = "sctype"));
...
sample <- run_sctype(sample, assay = "RNA", scaled = TRUE, known_tissue_type="Immune system",
                     custom_marker_file=system.file("extdata", "ScTypeDB_short.xlsx", package = "sctype"),
...
pbmc <- run_sctype(pbmc,known_tissue_type="Immune system",
                   custom_marker_file=system.file("extdata", "ScTypeDB_full.xlsx", package = "sctype"),
...
tissue_guess <- auto_detect_tissue_type(path_to_db_file = db_, 
                                        seuratObject = pbmc, scaled = TRUE, assay = "RNA") 
